// Features/Dashboard/Views/AchievementsView.swift
import SwiftUI
...
#Preview {
    AchievementsView(achievements: [
        Achievement(id: "1", title: "Getting Started", detail: "Completed your first check-in.", iconName: "checkmark.seal.fill", earnedDate: Date(), isUnlocked: true),
        Achievement(id: "2", title: "Week Strong", detail: "Maintained a 7-day streak.", iconName: "flame.fill", isUnlocked: false)
    ])
}
